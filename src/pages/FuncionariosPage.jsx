...
export default function FuncionariosPage() {
  ...
  useEffect(() => {
    ...
    // Verificamos se companyId existe E se NÃO é a string literal "undefined"
    // que está vindo da URL.
    if (companyId && companyId !== 'undefined') {
      // Passa a página atual (em formato 0-based) para a função de busca
      fetchWorkers(companyId, currentPage - 1, PAGE_SIZE);
    } else {
      // Opcional: logar o erro para facilitar o debug
      console.error("Busca de workers abortada: O companyId é nulo ou 'undefined'.");
      // Você pode querer setar um estado de erro aqui para avisar o usuário
    }
