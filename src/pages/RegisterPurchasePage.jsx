// DENTRO DE: src/pages/RegisterPurchasePage.jsx

import { useState, useEffect } from "react";
import { Button } from "@/components/ui/button";
import { Link, useLocation } from "wouter"; // Para links e pegar state
import Header from "@/components/Header"; // Assume que você tem um Header
...
export default function RegisterPurchasePage() {
  ...
  const [successKey, setSuccessKey] = useState(null); // Armazena a chave gerada

  // ----- Lógica do Calculador -----
  // ✅ CORREÇÃO: Removidos os ': number'
            ...
            // --- Tela de Sucesso ---
             <div className="bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 p-8 rounded-lg text-center shadow-md">
                ...
                <p className="text-muted-foreground mb-6">
                    Sua chave mestra foi criada e enviada para o seu email ({formData.email}). Guarde-a em um local seguro. Use esta chave para ativar sua conta no PCA Client.
                </p>
              ...
              <div className="bg-slate-50 dark:bg-slate-800 rounded-lg border border-border p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                        ...
                        <Input id="nome" name="nome" type="text" value={formData.nome} onChange={handleFormChange} required className="mt-1"/>
                    </div>
                    <div>
                        <Label htmlFor="email">Email de Contato *</Label>
                        <Input id="email" name="email" type="email" value={formData.email} onChange={handleFormChange} required className="mt-1"/>
                    </div>
                    <div>
                        <Label htmlFor="documento">CPF / CNPJ *</Label>
                        <Input id="documento" name="documento" type="text" value={formData.documento} onChange={handleFormChange} placeholder="Apenas números" required className="mt-1"/>
                    </div>
                     <div className="md:col-span-2">
