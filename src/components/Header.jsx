...
export default function Header({ setIsOpen }) {
  ...
  useEffect(() => {
    // Só busca se tiver 3 ou mais caracteres para evitar buscas muito amplas
  ...
  // Efeito para fechar o dropdown de busca ao clicar fora dele
  useEffect(() => {
  ...
  return (
    <header className="bg-white text-slate-600 shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-4">
          {/* Container da busca para controlar o "clique fora" */}
          <div ref={searchContainerRef} className="relative hidden lg:block">
            <input
              ...
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value.replace(/\D/g, ''))} // Permite apenas a digitação de números
            />
          ...
          <div className="relative">
            ...
            {isProfileMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-10 ring-1 ring-black ring-opacity-5">
                ...
                <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-sky-100 hover:text-sky-600">Meu Perfil</a>
